...
For 2d plots, each line represents the geometric average rate of return of a recommendation type overtime. Each recommendation type is annualized separately so some recommendation types might seem like they are more volatility, but this is usually because firms have fewer recommendations of a certain type than others. Additionally, the lines start at 1 instead of 0 so that the Y axis can be adjusted logarithmically.
